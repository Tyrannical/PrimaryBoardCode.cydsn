// ======================================================================
// PrimaryBoardCode.v generated from TopDesign.cysch
// 11/15/2016 at 10:00
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("077e5440-77e9-4988-9106-b9e29995d09e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("932dc277-b2e9-4eb1-bf14-8d31b81d8423"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("ec884846-b1a0-4fec-9e4d-f875e174dc61"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__MOSFET1_net;
	wire [0:0] tmpFB_0__MOSFET1_net;
	wire [0:0] tmpIO_0__MOSFET1_net;
	wire [0:0] tmpINTERRUPT_0__MOSFET1_net;
	electrical [0:0] tmpSIOVREF__MOSFET1_net;

	cy_psoc3_pins_v1_10
		#(.id("74cd3530-e837-41c7-90ec-e39aa87c953d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		MOSFET1
		 (.oe(tmpOE__MOSFET1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__MOSFET1_net[0:0]}),
		  .io({tmpIO_0__MOSFET1_net[0:0]}),
		  .siovref(tmpSIOVREF__MOSFET1_net),
		  .interrupt({tmpINTERRUPT_0__MOSFET1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MOSFET1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("ff2a0dc2-88da-48ed-a0f9-0cd1c66f6d7e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("24772310-064a-40f5-9ec0-b21af637357b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("cef5b127-b90c-4049-b85f-817f6f1bb8a3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
